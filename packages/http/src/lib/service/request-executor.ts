...
export class RequestExecutor {
   ...
   */
  private readonly _messageBus: MessageBus<HttpExecution<unknown>>
   ...
   */
  private readonly _retryAttemptCount: number | null;
  ...
  constructor(
    ...
    retryDelay: number,
    timeout: number,
    messageBus: MessageBus<HttpExecution<unknown>>,
  ) {
